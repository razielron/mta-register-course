exports.config = {
    ...
    capabilities: [{
        ...
        'goog:chromeOptions': {
            args: [
                ...
                // need non sandboxed chrome for the CI server as we run as root
                '--no-sandbox',
                '--browser-test', // removes memory pressure checks
    ...
    baseUrl: 'https://mtamn.mta.ac.il/yedion/fireflyweb.aspx',
    //
    ...
    jasmineOpts: {
        ...
        defaultTimeoutInterval: 60000 * 60 * 24,
        failFast: true,
        //
